...
int main()
{
    ...
    // Create an instances
    auto validator1 = std::make_shared<SpamValidator>();
    auto validator2 = std::make_shared<RequestValidator>();
    auto validator3 = std::make_shared<ComplaintValidator>();
    auto validator4 = std::make_shared<PraiseValidator>();

    // Build a chain
    validator1->setNextChain(validator2);
    validator2->setNextChain(validator3);
    validator3->setNextChain(validator4);
    
    e1.showEmail();
    validator1->validate(e1);
    std::cout << "----------------\n\n";

    e2.showEmail();
    validator1->validate(e2);
    std::cout << "----------------\n\n";

    e3.showEmail();
    validator1->validate(e3);
    std::cout << "----------------\n\n";

    e4.showEmail();
    validator1->validate(e4);
    std::cout << "----------------\n\n";
